...
`npm install angular-gridster3 --save`
...
import {GridsterComponent, GridsterItemComponent} from 'angular-gridster3';
...
```typescript
   import { GridsterConfig, GridsterItem }  from 'angular-gridster3';
